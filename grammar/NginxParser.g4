...
// 普通的s1项
field_group_ordinary: fg_left_ordinary (SPACE+ fg_right)+ SPACE* S1_DELIMITER SPACE* ;
...
// EVENTS 可包含内容
field_group_events: fg_left_events (op=SPACE+ fg_right)+ SPACE* S1_DELIMITER SPACE* ;
...
field_group_http_one: fg_left_http (op=SPACE+ fg_right)+ SPACE* S1_DELIMITER SPACE* ;
...
// SERVER 可包含内容
field_group_server: fg_left_server (op=SPACE+ fg_right)+ SPACE* S1_DELIMITER SPACE*;
fg_left_server: LISTEN|SERVER_NAME|ROOT|AUTOINDEX|AUTOINDEX_LOCALTIME|CHARSET;

// 特殊的可包含内容
field_group_one: DEFAULT_TYPE (op=SPACE+ fg_right)+ SPACE* S1_DELIMITER SPACE*;
